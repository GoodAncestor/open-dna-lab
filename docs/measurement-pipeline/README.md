...
- Preparations declare pre-dilution, assay volume and sample aliquot. Their product defines total dilution. Derived check concentrations are compared with one application of that factor.
